...
class FileBlockStore extends AbstractBlockStore {
  ...
  /**
   * This method stores block filter header in files.
   * @param {Buffer} hash - The block hash
   * @param {Buffer} data - The block data
   * @returns {Promise}
   */

  async writeHeader(hash, data) {
    return this._write(types.HEADER, hash, data);
  }
  ...
  async readHeader(hash) {
    return this._read(types.HEADER, hash);
  }
  ...
  /**
   * This will free resources for storing the block filter header.
   * @param {Buffer} hash - The block hash
   * @returns {Promise}
   */

  async pruneHeader(hash) {
    return this._prune(types.HEADER, hash);
  }
