...
const fs = require('fs');
const promisify = co.promisify;
const fsMkdir = promisify(fs.mkdir, fs);
const fsReaddir = promisify(fs.readdir, fs);
const fsOpen = promisify(fs.open, fs);
const fsStat = promisify(fs.stat, fs);
const fsFstat = promisify(fs.fstat, fs);
const fsWrite = promisify(fs.write, fs);
const fsRead = promisify(fs.read, fs);
const fsClose = promisify(fs.close, fs);
const fsFsync = promisify(fs.fsync, fs);
