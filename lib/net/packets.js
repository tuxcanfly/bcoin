...
function GetCFHeadersPacket() {
  if (!(this instanceof GetCFHeadersPacket))
    return new GetCFHeadersPacket();
...
exports.fromRaw = function fromRaw(cmd, data) {
  switch (cmd) {
    ...
    case 'getcfilter':
      return GetCFilter.fromRaw(data);
    case 'cfilter':
      return CFilter.fromRaw(data);
    case 'getcfheaders':
      return GetCFHeaders.fromRaw(data);
    case 'cfheaders':
      return CFHeaders.fromRaw(data);
    case 'tx':
