...
class PongPacket extends Packet {
  ...
  toRaw() {
    return this.toWriter(bio.static(8)).render();
  }
...
class CFilterPacket extends Packet {
  ...
  constructor(hash, extended, data) {
    super();
...
class GetCFHeadersPacket extends Packet {
  ...
  constructor(locator, stop, extended) {
    super();
    ...
    this.stop = stop || encoding.ZERO_HASH;
    this.extended = extended || false;
  }
...
class CFHeadersPacket extends Packet {
  ...
  constructor(stop, extended, hashes) {
    super();
...
class SendCmpctPacket extends Packet {
  ...
  toRaw() {
    return this.toWriter(bio.static(9)).render();
  }
...
class EncinitPacket extends Packet {
  ...
  toRaw() {
    return this.toWriter(bio.static(34)).render();
  }
