...
class Pool extends EventEmitter {
  ...
  async _handleHeaders(peer, packet) {
    ...
    // Request cfheaders
    peer.sendGetCFHeaders([node.hash], this.headerTip.hash, false);
    peer.sendGetCFHeaders([node.hash], this.headerTip.hash, true);
  ...
  */
  ...
  async getCFHeaders(peer, tip, stop) {
    const locator = await this.chain.getLocator(tip);
    peer.sendGetCFHeaders(locator, stop);
  }
