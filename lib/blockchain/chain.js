...
=======
    // Skip everything if we're in SPV or Neutrino mode.
>>>>>>> neutrino: request cfheaders
  ...
  async verify(block, prev, flags) {
    ...
    // Skip all blocks in spv or neutrino mode once
...
<<<<<<< HEAD
      ...
      this.location = this.neutrino
        ? path.join(this.prefix, 'neutrinochain')
        : this.location;
    }
=======
      if (this.spv) {
