...
const MemBlockStore = require('../blockstore/memory');
const NullBlockStore = require('../blockstore/null');
...
class ChainOptions {
  ...
  constructor(options) {
    ...
    this.blockStore = new NullBlockStore();
  ...
  fromOptions(options) {
    ...
    if (options.prefix != null) {
      ...
      this.blockStore = new FileBlockStore({
        location: path.join(this.prefix, 'blocks')
      });
    }
    ...
    if (options.location != null) {
      ...
      this.blockStore = new FileBlockStore({
        location: path.join(this.location, '../blocks')
      });
    }
    ...
    if (options.memory != null) {
      ...
      if (this.location == null && this.memory)
        this.blockStore = new MemBlockStore();
    }
