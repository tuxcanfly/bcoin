...
ChainDB.prototype.saveFilters = function saveFilters(block) {
  if (!this.options.commitFilters)
    return;
  ...
  // TODO: build filter header chain
};
...
ChainFlags.prototype.fromOptions = function fromOptions(options) {
  ...
  if (options.commitFilters != null) {
    assert(typeof options.commitFilters === 'boolean');
    this.commitFilters = options.commitFilters;
  }
