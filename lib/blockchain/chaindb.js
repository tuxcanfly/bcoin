...
ChainDB.prototype.putBlock = function putBlock(hash, value) {
  this.db.putBlock(hash, value);
};

ChainDB.prototype.delBlock = function delBlock(hash) {
  this.db.removeBlock(hash);
};

ChainDB.prototype.syncdb = function syncdb() {
  this.db.sync();
};
...
ChainDB.prototype.saveBlock = async function saveBlock(entry, block, view) {
  ...
  this.putBlock(hash, block.toRaw());
